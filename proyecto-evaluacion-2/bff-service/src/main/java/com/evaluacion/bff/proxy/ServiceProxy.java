...
public class ServiceProxy implements IOrqService {
    ...
    // Constructor usado por Spring en producción
    public ServiceProxy(
            RestTemplate restTemplate,
            @Value("${orq.service.url:http://orq-service:8081}") String serviceUrl) {
